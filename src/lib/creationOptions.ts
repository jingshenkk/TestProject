...
export const AI_MODEL_OPTIONS: AIModelOption[] = [
  {
    ...
    provider: 'DeepSeek（Anthropic 兼容）',
    description: 'LingJingOS 当前剧本主链路，模型名称由后端运行时配置校验。',
    features: ['长篇叙事', '结构化输出', '角色与分集规划', '推荐'],
    recommended: true,
  },
  {
    key: 'openai',
    ...
    description: '适合通用创意、跨语言表达和快速改写。',
    features: ['通用创意', '跨语言', '快速迭代', '兼容 API'],
    recommended: false,
  },
  {
    key: 'deepseek',
    label: 'DeepSeek Chat',
    provider: 'DeepSeek',
    description: '适合中文剧本迭代与高性价比的文本生产。',
    features: ['中文表达', '剧情补全', '成本可控', '长上下文'],
    recommended: false,
  },
];
